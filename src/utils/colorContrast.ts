 ...
 */
export function meetsWCAG(ratio: number, level: 'AA' | 'AAA' = 'AA', size: 'normal' | 'large' = 'normal') {
  if (level === 'AAA') {
 ...
 * 获取可读性评级
 */
export function getReadabilityRating(ratio: number) {
 ...
 * 检查颜色组合的可读性
 */
export function checkColorCombination(foreground: string | RgbColor, background: string | RgbColor) {
