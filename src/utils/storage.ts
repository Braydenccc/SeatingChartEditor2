 ...
 */
export function safeStorageGet(key: string, preferSession = false): string | null {
  try {
    if (preferSession) {
 ...
 */
export function safeStorageSet(key: string, value: string, useSession = false): boolean {
  try {
    if (useSession) {
 ...
 */
export function safeStorageRemove(key: string, clearBoth = false): boolean {
  try {
    if (clearBoth) {
