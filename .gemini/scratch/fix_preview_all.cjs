...
// 2. Update getCssFromStyle !important
content = content.replace(
...
// 4. Update generateSeatChartWorkbook / exportSeatChartToExcel arguments (global)
content = content.replace(
...
console.log('Successfully fully updated ExportPreview.vue!');
